  ...
  return (
    <div className="w-full h-full py-20">
      ...
      <div className="max-w-7xl mx-auto mt-20 px-4">
        <h2 className="text-2xl md:text-4xl font-bold text-neutral-800 dark:text-neutral-200 font-sans mb-6">
          Tab Stasher
        </h2>
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          <DialogTrigger asChild>
            <Button className="mb-4">Add Tab</Button>
          </DialogTrigger>
          <DialogContent>
            <DialogHeader>
            ...
            <div className="grid gap-4 py-4">
              ...
              />
              <Button onClick={handleAddTab}>Submit</Button>
            </div>
          </DialogContent>
        </Dialog>
        <div className="mt-4 space-y-2">
          {tabs.map((tab, index) => (
            <ExtractItem key={index} url={tab} />
          ))}
        </div>
      </div>
    </div>
