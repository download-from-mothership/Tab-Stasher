...
import "@/styles/parallax-page.css";

//
// Context and ID definitions

const parallaxPageId = "parallax-page";
...
const ParallaxPageStackContext = React.createContext<ParallaxPageStackContextValue | null>(null);
